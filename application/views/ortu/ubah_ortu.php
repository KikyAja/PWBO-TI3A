                    ...
                    <p class="card-text">
                        <form method="post">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?= $ortu['name_ibu'] ?>" name="ibu" id="ibu" aria-describedby="Nama ibu">
                            </div>
                            <div class="mb-3">
                                <label for="ayah" class="form-label">Nama Ayah</label>
                                <input type="text" class="form-control" value="<?= $ortu['name_ayah'] ?>" name="ayah" id="ayah" aria-describedby="Nama Ayah">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?= $ortu['telp'] ?>" name="telp" id="telp" aria-describedby="telp">
                            </div>
                            <div class="mb-3">
                                <label for="alamat" class="form-label">Alamat</label>
                                <textarea name="alamat" id="alamat" cols="30" row="10" class="form-control"><?= $ortu['alamat'] ?></textarea>
                            </div>
